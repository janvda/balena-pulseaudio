...
# removing display variable if set as in that case pulseaudio libraries are using
# that to decice where to connect to (see https://www.freedesktop.org/wiki/Software/PulseAudio/FAQ/)
unset DISPLAY
